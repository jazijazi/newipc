...
def transfer_initialborder_attachments():
    ...
    from initialborders.models.models import InitialBorderAttachment, InitialBorder, InitialBorderAttachmentDomain
    ...
    try:
        old_cursor.execute("""
            SELECT t.id, t.titletarh, t.dtarh_id, dt.codetarh
            FROM prjapi_tarh t
